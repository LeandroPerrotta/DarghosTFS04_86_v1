...
trade_lists = {
	...
	["runes"] = {
		...
		{ name = "fire bomb rune", sell_for = 28 },
	...
	["rashid"] = {	
		{ name = "dragon scale mail", buy_for = 60000 },	
		{ name = "glacier robe", buy_for = 16500 },	
		{ name = "golden armor", buy_for = 30000 },	
		{ name = "lightning robe", buy_for = 16500 },	
		{ name = "magma coat", buy_for = 16500 },	
		{ name = "paladin armor", buy_for = 15000 },	
		{ name = "skullcracker armor", buy_for = 18000 },	
		{ name = "terra mantle", buy_for = 16500 },	
		{ name = "glacier kilt", buy_for = 16500 },	
		{ name = "lightning legs", buy_for = 16500 },	
		{ name = "magma legs", buy_for = 16500 },	
		{ name = "terra legs", buy_for = 16500 },	
		{ name = "demon shield", buy_for = 45000 },	
		{ name = "medusa shield", buy_for = 13500 },	
		{ name = "spellbook of enlightenment", buy_for = 6000 },	
		{ name = "glacier mask", buy_for = 3750 },	
		{ name = "lightning headband", buy_for = 3750 },	
		{ name = "magma monocle", buy_for = 3750 },	
		{ name = "skull helmet", buy_for = 60000 },	
		{ name = "fur boots", buy_for = 3000 },	
		{ name = "glacier shoes", buy_for = 3750 },	
		{ name = "lightning boots", buy_for = 3750 },	
		{ name = "magma boots", buy_for = 3750 },	
		{ name = "steel boots", buy_for = 45000 },	
		{ name = "terra boots", buy_for = 3750 },	
		{ name = "amber staff", buy_for = 12000 },	
		{ name = "chaos mace", buy_for = 18000 },	
		{ name = "demonrage sword", buy_for = 54000 },	
		{ name = "dragon slayer", buy_for = 22500 },	
		{ name = "guardian halberd", buy_for = 16500 },	
		{ name = "wyvern fang", buy_for = 13500 },	
		{ name = "ring of the sky", buy_for = 45000 },	
		{ name = "relic sword", buy_for = 37500 },	
		{ name = "dragonbone staff", buy_for = 4500 },	
	},
